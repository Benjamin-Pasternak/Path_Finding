...
#                 self.heap_list[i // 2] = self.heap_list[i]
#                 self.heap_list[i] = temp
#             # secondary sorting based on smaller g values
#             if self.heap_list[i][0] == self.heap_list[i // 2][0]:
#                 if self.heap_list[i][1].g < self.heap_list[i // 2][1].g:
#                     temp = self.heap_list[i // 2]
#                     self.heap_list[i // 2] = self.heap_list[i]
#                     self.heap_list[i] = temp
#                 else:
...
#                 self.heap_list[i] = self.heap_list[mc]
#                 self.heap_list[mc] = temp
#             elif self.heap_list[i][0] == self.heap_list[mc][0]:
#                 if self.heap_list[i][1].g < self.heap_list[mc][1].g:
#                     temp = self.heap_list[i]
#                     self.heap_list[i] = self.heap_list[mc]
#                     self.heap_list[mc] = temp
#             i = mc
...
#     # find the minimum child between two positions
#
#     # fix min child and sift down so they account for the tie break in g
#     def min_child(self, i):
#         if i * 2 + 1 > self.current_size:
#             return i * 2
#         else:
#             if self.heap_list[i * 2][0] < self.heap_list[i * 2 + 1][0]:
#                 return i * 2
#             # blocked off portion is for g prioritization
#             ############
#             elif self.heap_list[i * 2][0] == self.heap_list[i * 2 + 1][0]:
#                 if self.heap_list[i * 2][1].g <= self.heap_list[i * 2 + 1][1].g:
#                     return i * 2
#                 else:
#                     return i * 2 + 1
#                 ############################
